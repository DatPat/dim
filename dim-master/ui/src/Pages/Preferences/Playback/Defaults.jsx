...
function Defaults() {
  ...
  // Settings may not be fetched yet (or the user never set a default) —
  // treat anything without a resolution tuple as Direct Play instead of
  // crashing on `default_quality.resolution` below.
  const hasResolution =
    default_quality &&
    typeof default_quality === "object" &&
    Array.isArray(default_quality.resolution);
  const isDirectPlay = !hasResolution;
