...
export const WT_SET_ROOM = "WT_SET_ROOM";
export const WT_LEAVE_ROOM = "WT_LEAVE_ROOM";
export const WT_SYNC_PLAYBACK = "WT_SYNC_PLAYBACK";
export const WT_UPDATE_PARTICIPANTS = "WT_UPDATE_PARTICIPANTS";
export const WT_ADD_CHAT_MESSAGE = "WT_ADD_CHAT_MESSAGE";
export const WT_ROOM_DESTROYED = "WT_ROOM_DESTROYED";
export const WT_SET_BUFFERING = "WT_SET_BUFFERING";
export const WT_TOGGLE_CHAT = "WT_TOGGLE_CHAT";
export const WT_SET_ERROR = "WT_SET_ERROR";
export const WT_SET_READY = "WT_SET_READY";
export const WT_SET_CONTROL_MODE = "WT_SET_CONTROL_MODE";
export const WT_MODE_CHANGED = "WT_MODE_CHANGED";
export const WT_SET_EXTERNAL_HOST_FILE = "WT_SET_EXTERNAL_HOST_FILE";
export const WT_EXPECT_EPISODE = "WT_EXPECT_EPISODE";
