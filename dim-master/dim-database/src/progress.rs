...
/// Fraction of a file's duration past which the item counts as fully
/// watched. Outros/credits routinely occupy the last few percent, so
/// bailing out there must not leave the item stuck as "in progress".
...
impl Progress {
    pub fn is_watched(delta: i64, duration: i64) -> bool {
        duration > 0 && delta as f64 / duration as f64 > WATCHED_THRESHOLD
    }
